...
export class ArchivosComponent {
  ...
  getFileFieldHeight(): string {
    const fileCount = this.selectedFiles.length;
    const minHeight = 56; // Altura mínima del campo de entrada
    const additionalHeightPerFile = 24; // Altura adicional por cada archivo
  
    const calculatedHeight = minHeight + fileCount * additionalHeightPerFile;
